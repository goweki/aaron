...
export default function LandingPage() {
  ...
  return (
    <main className="flex flex-col items-center justify-between p-8 lg:p-16 max-h-[800px] w-full">
      ...
      <section className="grid text-center lg:w-full lg:max-w-5xl lg:grid-cols-3 lg:text-left space-x-4 md:my-4">
        <button
          className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-slate-700 hover:bg-slate-100 hover:dark:bg-slate-800 hover:dark:border-neutral-700"
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Click to {listen ? "stop listening" : "start listening"} for speech
            recognition.
          </p>
        </button>
      </section>
