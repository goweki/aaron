...
const WelcomeHtml = ({ name, onboardLink }: WelcomeEmailProps) => {
  return (
    <Html>
      <Head />
      <Body style={main}>
        <Preview>Welcome to Q-Sync</Preview>
        <Container style={container}>
          ...
          <Section>
            ...
            <Text style={text}>
              Thank you for signing up to Q-Sync. We&apos;re excited to have you
              on board! We look forward to helping you streamline your booking
              queues.
            </Text>
            <Text style={text}>
...
const welcomeEmailText = ({ name, onboardLink }: WelcomeEmailProps) =>
  `Hello ${name},
Thank you for signing up to Q-Sync. We're excited to have you onboard! 
& look forward to helping you streamline your booking queues.

To finish setting up your account, create a new password using
              this link: ${onboardLink}

The link is valid for only 1 hour. If you have any questions, feel free 
to contact support via q-sync@gaddj.com
